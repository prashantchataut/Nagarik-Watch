...
The front page _knows_ it is a Nepali news portal, but live it sells chrome confidence while delivering thin repeating inventory and a publicly failed live strip. Behind that, publishing/search/health paths can lie to editors and monitors. Fix status honesty, story uniqueness, and publish→read integrity before more section polish.
