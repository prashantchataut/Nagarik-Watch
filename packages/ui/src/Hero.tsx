  ...
  return (
    <article className={cn('group', className)}>
      ...
      {showLeadPhoto ? (
        <Link
          href={href}
          className="relative mt-3 block overflow-hidden bg-surface-raised focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand aspect-[16/10] sm:aspect-[16/9] xl:mt-4"
        >
          <Image
        ...
        <div className="mt-3 border-y border-rule xl:mt-4" aria-hidden="true" />
      )}
    </article>
  )
}
