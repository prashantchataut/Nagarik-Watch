...
assert(
  auth.includes('Promise.allSettled'),
  'boot provisioning must report every configured account failure',
)
...
assert(
  jsonStore.includes('JSON article store is disabled in production'),
