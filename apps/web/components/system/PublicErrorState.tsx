        ...
        <div className="max-w-2xl">
          ...
          {showSearch ? (
            <form
              ...
              className="mt-7 flex w-full max-w-xl border border-rule bg-surface"
            >
              ...
              <button
                type="submit"
                className="min-h-12 border-l border-rule px-4 text-meta font-extrabold text-brand-strong hover:bg-brand-tint"
              >
                {en ? 'Search' : 'खोज'}
              </button>
            </form>
