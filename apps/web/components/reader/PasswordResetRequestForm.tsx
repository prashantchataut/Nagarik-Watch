...
export function PasswordResetRequestForm({ locale, next }: { locale: 'ne' | 'en'; next?: string | null }) {
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4" noValidate>
      ...
      <button type="submit" disabled={pending} className="mt-2 inline-flex h-11 w-full items-center justify-center border border-brand bg-brand px-5 text-body font-bold text-paper transition-colors duration-fast ease-out-quint hover:bg-brand-strong focus:outline-none focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-60">
