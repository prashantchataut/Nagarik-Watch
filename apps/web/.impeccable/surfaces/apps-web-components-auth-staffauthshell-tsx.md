...
- Mode: Operate
- Audience: readers signing in optionally; invited reporters; provisioned editors/admins
- Job: honest role switch, form-first mobile, dense desk brief on large screens
- Direction: product register; Civic Crimson accents; Mukta titles; no marketing hero
- Constraints: Google gated; Option A free-to-read copy; no fake OAuth; Nepali-first staff copy; square CTAs (no pill costume); MFA stub uses newsroom-login language
