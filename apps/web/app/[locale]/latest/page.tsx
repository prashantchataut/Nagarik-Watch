...
/**
 * Latest — the chronological firehose across every section, newest first. This is the
 * target of the bottom-nav "ताजा / Latest" tap, so a reader can always get to the most
 * recent reporting in one step regardless of where they are.
 *
 * Backed by the real content source (`getStories`, sorted newest-first), paginated like the
 * category pages. No mock data; this is genuine "most recent published" ordering.
 */
