  ...
  return (
    <div className="mx-auto max-w-page px-3 py-4 sm:px-4 sm:py-5">
      ...
      {stories.items.length ? (
        ...
        <p
          // Stable hook for the e2e empty-state assertion: the wording here is
          // editorial copy and has been reworded before, which silently broke
          // the test that matched on it.
