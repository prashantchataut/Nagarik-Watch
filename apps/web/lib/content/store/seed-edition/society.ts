...
export function editionSociety(): StoredArticle[] {
  return [
    base({
      ...
      deckNe:
        'पहिरो र बाढीले राजमार्ग अवरुद्ध हुँदा यातायात, बजार आपूर्ति र स्वास्थ्य सेवामा चाप बढेको छ।',
      deckEn:
        'Landslides and floods blocking highways raise pressure on transport, markets and health access.',
    ...
    base({
      ...
      deckNe:
        'वर्षाले नाली अवरुद्ध र फोहोर थुप्रिँदा स्वास्थ्य जोखिम बढ्छ। नगर सेवा र नागरिक सहकार्य दुवै चाहिन्छ।',
      deckEn:
        'Rain-clogged drains and piled waste raise health risks; city services and civic habits both matter.',
    ...
    base({
      ...
      bodyEn: [p('Complaint channels, lighting and crew training must move together.')],
    }),
    base({
      id: 'art-ed-society-4',
      ...
      deckNe:
        'स्वास्थ्यकर्मी अभावले मातृशिशु सेवामा असर पर्छ। सरुवा, तालिम र औषधि आपूर्ति सँगै हेर्नुपर्छ।',
      deckEn:
        'Staffing gaps hit maternal care; transfers, training and medicine supply must align.',
      ...
      bodyNe: [
        ...
        list(['रिक्त दरबन्दीको सार्वजनिक सूची', 'आकस्मिक औषधि बफर स्टक', 'रेफरल यातायात तयारी']),
        p('नागरिक वाच डेस्कले यस विषयलाई निरन्तर अनुगमन गरी पाठकमैत्री सार अद्यावधिक गर्नेछ।'),
      ],
      bodyEn: [
    ...
    base({
      ...
      bodyNe: [
        ...
        list(['आपतकालीन झोला र कागजात कपी', 'छिमेकी सम्पर्क सूची', 'निकासी मार्गको पूर्वजानकारी']),
        p('नागरिक वाच डेस्कले यस विषयलाई निरन्तर अनुगमन गरी पाठकमैत्री सार अद्यावधिक गर्नेछ।'),
      ],
      bodyEn: [p('Drills, go-bags and contact lists can reduce harm in high-risk settlements.')],
    }),
  ]
}
