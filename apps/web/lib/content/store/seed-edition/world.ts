...
export function editionWorld(): StoredArticle[] {
  return [
    base({
      ...
      deckNe:
        'वैश्विक इन्धन मूल्य उकालो लाग्दा आयात बिल र यातायात खर्चमा चाप पर्छ। तयारी र पारदर्शिता चाहिन्छ।',
      deckEn:
        'Global fuel spikes hit import bills and transport costs; preparation and transparency matter.',
      ...
      bodyNe: [
        ...
        list(['इन्धन मौज्दात स्थिति', 'सार्वजनिक यातायात विकल्प', 'मूल्य समायोजन प्रक्रिया']),
    ...
    base({
      ...
      bodyNe: [
        ...
        list(['नदी प्रवाह आदानप्रदान', 'पूर्वसूचना भाषा सरलता', 'सीमावर्ती राहत समन्वय']),
        p('नागरिक वाच डेस्कले यस विषयलाई निरन्तर अनुगमन गरी पाठकमैत्री सार अद्यावधिक गर्नेछ।'),
      ],
      bodyEn: [p('Rain systems cross borders; flood warning cooperation can cut losses.')],
    }),
    base({
      id: 'art-ed-world-3',
      ...
      deckNe:
        'गन्तव्य मुलुकको नीति फेरिँदा नेपाली परिवारको आय प्रभावित हुन्छ। सूचना पहुँच महत्त्वपूर्ण छ।',
      deckEn:
        'Destination policy shifts affect Nepali household income; information access matters.',
      ...
      bodyNe: [
        ...
        list(['कानुनी कामदार मार्ग', 'शुल्क पारदर्शिता', 'गुनासो संयन्त्र']),
        p('नागरिक वाच डेस्कले यस विषयलाई निरन्तर अनुगमन गरी पाठकमैत्री सार अद्यावधिक गर्नेछ।'),
      ],
      bodyEn: [
    ...
    base({
      ...
      deckNe:
        'सम्मेलनका वाचा घरेलु नीतिमा झर्दा मात्र अर्थ राख्छन्। अनुकूलन र वित्त दुवै हेर्नुपर्छ।',
      ...
      bodyNe: [
        ...
        list(['हिमाली जोखिम', 'कृषि बीमा', 'हरित वित्त पहुँच']),
        p('नागरिक वाच डेस्कले यस विषयलाई निरन्तर अनुगमन गरी पाठकमैत्री सार अद्यावधिक गर्नेछ।'),
      ],
      bodyEn: [
    ...
    base({
      ...
      deckNe:
        'संघर्ष र विपद्ले मानिस विस्थापित हुँदा अन्तर्राष्ट्रिय मापदण्ड र स्थानीय तयारी दुवै जाँच्नुपर्छ।',
      deckEn:
        'Conflict and disaster displacement test international standards and local readiness.',
      ...
      bodyNe: [
        ...
        list(['सुरक्षित आश्रय', 'सूचना पहुँच', 'बालबालिका संरक्षण']),
        p('नागरिक वाच डेस्कले यस विषयलाई निरन्तर अनुगमन गरी पाठकमैत्री सार अद्यावधिक गर्नेछ।'),
      ],
      bodyEn: [
