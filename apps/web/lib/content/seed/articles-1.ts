...
export const articlesBatch1: Article[] = [
  // -- POLITICS ---------------------------------------------------------------
  {
    ...
    bodyNe: [
      ...
      },
      {
        ...
        ordered: false,
        items: [
          'सभापति: ५१ हजार रुपैयाँ',
          'उपसभापति: ३१ हजार रुपैयाँ',
          'महासचिव: २१ हजार रुपैयाँ',
        ],
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    seoDescriptionNe: 'सर्वोच्च अदालतको जग्गा दर्ता सम्बन्धी फैसलाले प्रक्रियामा स्पष्टता ल्याएको छ।',
  },
  ...
  },
  {
    ...
    deckNe: 'विश्वबजारमा कच्चा तेलको मूल्य उच्च भएकाले आगामी दिनमा स्थानीय भाउ प्रभावित हुने अनुमान छ।',
